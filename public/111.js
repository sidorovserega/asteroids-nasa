export const data = {
  links: {
    next: 'http://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-08&end_date=2015-09-08&detailed=false&api_key=DEMO_KEY',
    prev: 'http://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-06&end_date=2015-09-06&detailed=false&api_key=DEMO_KEY',
    self: 'http://api.nasa.gov/neo/rest/v1/feed?start_date=2015-09-07&end_date=2015-09-07&detailed=false&api_key=DEMO_KEY',
  },
  element_count: 13,
  near_earth_objects: {
    '2023-08-20': [
